...
python -m pip install -r requirements/biom3.txt        # pinned BioM3-dev (see SYNC_LOG.md)

# To install a different BioM3-dev version, edit requirements/biom3.txt or run e.g.
