...
Requires BioM3-dev installed (`pip install -r requirements/biom3.txt` for the pinned version, or `pip install -e /path/to/BioM3-dev` for a local checkout). Source `environment.sh` before running pipeline steps.
