#!/bin/bash
#=============================================================================
# Step 800: Plot Structural Comparison Results
#
...
#
# USAGE:
#   ./pipeline/0800_plot_results.sh <results_csv> <output_dir> [--colabfold-csv <path>]
#
# EXAMPLE:
...
#
# INPUT:
#   <results_csv>: results.csv from Step 700 (TMalign comparison metrics)
#
# OUTPUT:
...
echo "============================================="
echo "Step 800: Plot Structural Comparison Results (workflow v${BIOM3_WORKSPACE_VERSION:-unknown})"
echo "============================================="
